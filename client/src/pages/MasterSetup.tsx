...
export default function MasterSetup() {
  ...
  const setup = trpc.account.setupMasterAdmin.useMutation({ onSuccess: async () => { await utils.auth.me.invalidate(); toast.success("Master Admin account created."); setLocation("/admin/approvals"); } });
