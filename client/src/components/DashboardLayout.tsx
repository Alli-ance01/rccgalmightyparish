...
import { CalendarDays, HandHeart, Images, LayoutDashboard, LogOut, Megaphone, PanelLeft, ShieldCheck, Video, Waypoints } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Waypoints, label: "Ministries", path: "/admin", tab: "ministries" },
